...
struct SidebarAgentHoverTests {
    ...
    private func session(id: UUID? = nil, surface: UUID? = nil, name: String = "model") -> SidebarCopilotSession {
        .init(
            id: id ?? fixtures.sessionID, workspaceID: fixtures.workspaceA,
            surfaceID: surface ?? fixtures.surfaceA, liveness: .alive, state: .working, model: name,
