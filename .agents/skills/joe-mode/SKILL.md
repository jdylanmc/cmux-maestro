...
The separate human-enabled [CMUX cockpit](../joe-mode-cmux/SKILL.md),
[Paseo PM adapter](../joe-mode-paseo/SKILL.md) and
...
CMUX's exact managed run, Paseo's saved activation/wakeup/pass and Orca's actual
Run, coordinator, Dispatches and owned automations. Join an existing logical
